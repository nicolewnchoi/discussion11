...
document.querySelector("#collaborator-name").innerHTML = "Chloe";
document.querySelector("#host-name").innerHTML = "Nicole";
...
element.addEventListener("click", hide_instructions);
...
name.addEventListener("change", autoComplete);
function autoComplete(name) {
  if (name === "John") {
    document.querySelector("#last_name").innerHTML = "Doe";
  }
}
